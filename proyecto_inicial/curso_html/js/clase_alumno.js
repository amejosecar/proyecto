...
export class Alumno {
  ...
  constructor(
    ...
    if (
      ...
      !Alumno.validarValores(genero, Alumno.generosAceptables())
    ) {
      throw new Error(
        "El género debe ser un array y contener valores aceptables."
      );
    }
    if (!Alumno.validarCalificacion(calificacion))
      throw new Error(
